...
def preprova_page():
    ...
    # 🔹 Recarregar os dados toda vez que a página for acessada
    ...
    # 🔹 Exibir todas as pré-provas carregadas do banco
...
def delete_preprova(preprova_id):
    ...
    try:
        ...
        # 🔹 Atualiza a lista de pré-provas na sessão sem precisar recarregar a página
